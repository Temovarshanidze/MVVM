...
class MovieCell: UITableViewCell {
    ...
    weak var delegate: MovieAddDelegate?
    ...
    private func setupUI() {
        ...
        contentView.addSubview(raitingLabel) // სწორად ჩამატებული სახელით
        ...
        NSLayoutConstraint.activate([
            ...
            favoriteButton.topAnchor.constraint(equalTo: genreLabel.topAnchor, constant: -30),
            favoriteButton.rightAnchor.constraint(equalTo: contentView.rightAnchor, constant: -15)
